    ...
    <div class="box box-warning">
        ...
        <div class="box-body">
            <form action="" enctype="multipart/form-data"  role="form" method="post">
                ...
                <div class="form-group">
                    <label>Tác giả</label>
                    <input id = "input_document_name" name = "input_author" type="text" value="{{$document->author}}" class="form-control"  >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Khoa</label>
                    <select id = "input_type" name = "input_department" class="form-control">
